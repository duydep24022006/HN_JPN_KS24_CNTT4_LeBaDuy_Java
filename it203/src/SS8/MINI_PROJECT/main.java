...
public class main {
    ...
    static String readStudentId(StudentManager manager) {
        while (true) {
    ...
    static void addStudentFlow(StudentManager manager) {
        String id = readStudentId(manager);
    ...
    static void updateStudentFlow(StudentManager manager) {
    ...
    static void deleteStudentFlow(StudentManager manager) {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    updateStudentFlow(manager);
                    break;
                case 5:
                    deleteStudentFlow(manager);
                    break;
                case 6:
